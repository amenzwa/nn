...
**_error back-propagation supervised learning algorithm_**—EBP is a connectionist reimagining of the well known [gradient descent optimisation](https://en.wikipedia.org/wiki/Gradient_descent) technique invented by [Cauchy](https://en.wikipedia.org/wiki/Augustin-Louis_Cauchy) in 1847. The innovation that EBP brings is the efficient, parallel implementation, which is a common trait of neural network algorithms.
